...
import { INITIAL_BOOKING, type BookingData, type Lang } from "@/lib/booking-types";

// The multi-step public booking flow, rendered per business at /b/[slug].
export default function PublicBookingApp() {
  const { biz } = usePublicBiz();
